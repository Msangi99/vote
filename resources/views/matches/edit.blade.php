...
<body class="bg-gray-50 font-sans flex min-h-screen">
    ...
    <div class="flex-1 p-6 md:p-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            <h1 class="text-3xl font-extrabold text-gray-800">Edit Match</h1>
                ...
                <form action="{{ route('matches.update', $match->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="datetime-local"
                               ...
                               required>
                        <p class="mt-1 text-xs text-gray-500">Update the scheduled date and time if needed.</p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text"
                               ...
                               placeholder="e.g. 2-1 or Postponed">
                        <p class="mt-1 text-xs text-gray-500">Leave blank if not played yet, or update after match.</p>
                    </div>
